...
This is a sample template for drone-zone-helpers - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name drone-zone-helpers --tail
```
...
```bash
aws cloudformation delete-stack --stack-name drone-zone-helpers
```

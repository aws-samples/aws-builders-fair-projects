...
public class KinesisClientProviderWithDefaultCredentials implements AWSClientsProvider {
  private final Regions region;

  public KinesisClientProviderWithDefaultCredentials(Regions region) {
    this.region = region;
  }
